...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=2a4cae85649f70953dd6672086f76bd1'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyBFQxxkkf8qJI7JfrkSdroh6n0HHeOeyCE'

    SEARCH_ENGINE_ID = 'a05b6934c439f4cb9'
